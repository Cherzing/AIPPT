    ...
    return (
        <div className='fixed top-0 left-0 w-full h-full flex flex-col items-center justify-center'>
            <div className='flex flex-col items-center justify-center'>
                ...
                {trackingEnabled !== null && (
                    <div className='flex items-center gap-3 mt-8 px-5 py-3.5 rounded-[10px] border border-[#EDEEEF] bg-white'>
                        <div>
                            ...
                            <p className='text-[11px] text-[#9CA3AF] font-syne leading-tight mt-0.5'>Help improve AI PPT by sharing anonymous usage data.</p>
                        </div>
                        <Switch
                ...
                <button onClick={handleGoToUpload} className='bg-[#7C51F8] px-[23px] mt-8 py-[15px]  rounded-[70px] text-white text-lg font-syne font-semibold'>我的第一份演示文稿 🚀</button>
