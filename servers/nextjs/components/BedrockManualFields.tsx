    ...
    <div className="mt-3 w-full min-w-0 max-w-full space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className={inputClass}
          placeholder="填写此项，或填写下方 AWS 访问密钥"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className={inputClass}
          placeholder="与 AWS Secret Access Key 配合使用"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className={inputClass}
          placeholder="与 AWS Access Key ID 配合使用"
        />
      </div>

      <p className="text-xs text-gray-500">
        认证方式：填写 Bedrock API Key，或填写 AWS Access Key ID + Secret Key。
      </p>
