...
export const Schema = z.object({
  ...
  contactItems: z.array(ContactItemSchema).min(2).max(5).default([
    { label: "邮箱", value: "report@example.com" },
    { label: "Resource", value: "www.example.com/report" },
    { label: "后续跟进", value: "Next review cycle" },
  ]).meta({
      ...
      >
        ...
        <div className="grid h-full grid-cols-[1fr_430px] gap-[42px] px-[64px] py-[58px]">
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              <p className="text-[15px] font-bold uppercase leading-none opacity-80">联系方式</p>
            ...
            >
              <p className="text-[15px] font-bold uppercase leading-none text-[#157CFF]" style={{ color: "var(--primary-color,#157CFF)" }}>后续跟进</p>
