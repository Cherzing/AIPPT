...
const DEFAULT_SECTIONS = [
  ...
  { number: "02", title: "方法", description: "Sources, assumptions, and collection approach." },
    ...
    <>
      ...
      >
        <div className="flex flex-col px-[62px] py-[62px]" style={{ backgroundColor: "var(--primary-color,#157CFF)", color: "var(--primary-text,#ffffff)" }}>
          <p className="text-[18px] font-semibold uppercase tracking-normal opacity-85">章节</p>
