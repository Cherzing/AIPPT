    ...
    <>
      ...
      >
        ...
        <div className="mx-[64px] mt-[26px] grid grid-cols-[1.05fr_0.95fr] gap-[24px]">
          ...
          >
            <p className="text-[15px] font-bold uppercase leading-none text-[#157CFF]" style={{ color: "var(--primary-color,#157CFF)" }}>方法</p>
          ...
          <div className="grid gap-[18px]">
            ...
            >
              <p className="text-[15px] font-bold uppercase leading-none text-[#157CFF]" style={{ color: "var(--primary-color,#157CFF)" }}>来源</p>
