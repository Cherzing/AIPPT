...
export const Schema = z.object({
    title: z.string().max(10).describe('The main heading of the slide').default('谢谢'),
    ...
    email: z.string().max(30).describe('Email address text').default('contact@aippt.local'),
    website: z.string().max(30).describe('Website URL text').default('www.aippt.local'),
