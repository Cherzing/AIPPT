...
# Simple branded success page for AI PPT authentication
...
<body>
  <main class="card">
    ...
    <p>You can now return to AI PPT to continue.</p>
...
<body>
  <main class="card">
    ...
    <p>We’ll gently reload this page. If the issue persists, close this window and restart sign-in from AI PPT.</p>
